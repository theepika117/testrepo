...
def review_order(ticker, remaining_capital):
    ...
    _, position_price, position_quantity = check_positions(ticker)                                          #fetches position price and quantity
    if position_price >= remaining_capital and position_quantity > 0:#continue
